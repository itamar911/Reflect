  ...
  return (
    <div>
      ...
      <div className="flex flex-col gap-3">
        <OptionButton active={value === 'day'} onClick={() => onChange('day')} icon="⚡" label="Day Trading" description="פתיחה וסגירה של עסקאות ביום אחד" />
...
function Step5({ data }: { data: WizardData }) {
  const tradingLabels: Record<TradingType, string> = { day: 'Day Trading', swing: 'Swing Trading', crypto: 'Crypto Trading' };
  const marketLabels: Record<Market, string> = { stocks: 'מניות', crypto: 'קריפטו', forex: 'פורקס' };
