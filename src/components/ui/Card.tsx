...
export default function Card({ className, children, padding = 'md', gold = false }: CardProps) {
  ...
  return (
    <div
      ...
      style={gold ? {
        background: 'linear-gradient(135deg, rgba(245,197,24,0.09) 0%, rgba(13,17,23,0.95) 100%)',
        borderColor: 'rgba(245,197,24,0.22)',
        boxShadow: '0 0 24px rgba(245,197,24,0.09), inset 0 1px 0 rgba(245,197,24,0.13)',
      } : {
