...
const TYPE_ICON: Record<string, ReactNode> = {
  revenge: <RefreshCw aria-hidden="true" size={14} />, loss_hours: <Clock aria-hidden="true" size={14} />, weak_setup: <TrendingDown aria-hidden="true" size={14} />,
  emotional: <Smile aria-hidden="true" size={14} />, discipline: <AlertTriangle aria-hidden="true" size={14} />, positive: <CheckCircle aria-hidden="true" size={14} />,
};
          ...
          {patterns.map((p, i) => (
            <div key={i}>
              <button
                ...
                <span className="text-base shrink-0">{TYPE_ICON[p.type] ?? <BarChart2 aria-hidden="true" size={14} />}</span>
