...
//
// The page is a two-row column: the card row takes the slack and keeps the
// card centred inside it, and the risk disclosure is the second row, so the
// disclosure sits below the card instead of pulling it off centre.
export default function AuthLayout({ children }: { children: React.ReactNode }) {
  return (
    <div className="min-h-screen flex flex-col" style={{ background: 'var(--color-tg-bg)' }}>
      <div className="flex-1 flex items-center justify-center px-4 py-6 lg:px-10 lg:py-8">
        <div
