    ...
    <>
      ...
      >
        ...
        <Section n={11} title="תוכן וקניין רוחני">
          ...
          <P>
            11.3 תוכלו לבקש עותק של הנתונים שלכם בכל עת, כל עוד החשבון פעיל, בפנייה לכתובת{' '}
            <SupportEmail />. יש להגיש את הבקשה לפני סגירת החשבון: הסגירה מיידית ובלתי הפיכה,
            ולאחריה לא נותרים נתונים שניתן להפיק מהם עותק. הטיפול בבקשה מתבצע כמפורט במדיניות
            הפרטיות.
          </P>
        </Section>
